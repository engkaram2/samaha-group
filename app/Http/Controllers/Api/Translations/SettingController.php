...
//
//        if (!$about_app = TranslationSetting::where('key', $about_app)->first()->value) {
...
//    }
    ...
    {
        $sections = AboutSection::where(['type' => 'translation'])->get();
    ...
    public function conditionsAndTerms()
    {
        ...
        if (!$conditions_terms = TranslationSetting::where('key', $conditions_terms)->first()->value) {
            return responseJson(false, trans('api.page_not_found'), null);//NOT_FOUND
        }
