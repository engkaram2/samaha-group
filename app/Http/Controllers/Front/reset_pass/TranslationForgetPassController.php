...
class TranslationForgetPassController extends Controller
{
// =========== reset password ===========================
    public function forget_pass(ForgetPassRequest $request)
    {
        ...
        return redirect()->route('front.translation-confirm-code-page', $request->email);
    }


    public function confirmCodePage($email)
    {
        return view('Front.Translation.Auth_pages.confirm_code_page', compact('email'));
    }
    ...
    public function checkConfirmCode(Request $request)
    {
        ...
        return redirect()->route('front.translation-change-password-page');

    }

    public function changePasswordPage()
    {
        return view('Front.Translation.Auth_pages.new_password_page');
    }
...
//        Auth::guard('web')->logout();
        ...
        return redirect()->route('front.translation-home');
    }
}
