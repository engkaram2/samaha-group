...
class LegalForgetPassController extends Controller
{
// =========== reset password ===========================
...
//        Mail::to('elshenaweymona92@gmail.com')->send(new ConfirmCode($code));
        ...
        return redirect()->route('front.legal-confirm-code-page', $request->email);
    }


    public function confirmCodePage($email)
    {
        return view('Front.Legal.Auth_pages.confirm_code_page', compact('email'));
    }
    ...
    public function checkConfirmCode(Request $request)
    {
        ...
        return redirect()->route('front.legal-change-password-page');

    }

    public function changePasswordPage()
    {
        return view('Front.Legal.Auth_pages.new_password_page');
    }
