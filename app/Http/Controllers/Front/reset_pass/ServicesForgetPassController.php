...
class ServicesForgetPassController extends Controller
{
// =========== reset password ===========================
...
//        Mail::to($request->email)->send(new ConfirmCode($code));
        ...
        return redirect()->route('front.services-confirm-code-page', $request->email);
    }


    public function confirmCodePage($email)
    {
        return view('Front.Services.Auth_pages.confirm_code_page', compact('email'));
    }
    ...
    public function checkConfirmCode(Request $request)
    {
        ...
        return redirect()->route('front.services-change-password-page');

    }

    public function changePasswordPage()
    {
        return view('Front.Services.Auth_pages.new_password_page');
    }
...
//        Auth::guard('web')->logout();
        ...
        return redirect()->route('front.services-home');
    }
}
