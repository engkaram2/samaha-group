...
class ServicesAuthController extends Controller
{
    public function servicesProfile()
    {
        ...
        return view('Front.Services.Auth_pages.profile',$data);
    }

    public function servicesIssues()
    {
        $data['user'] = User::where('id', Auth::user()->id)->first();
        $data['my_issues'] = Issue::where(['user_id'=> Auth::user()->id,'type'=>'services'])->get();
        $data['my_appointments'] = Appointment::where(['user_id'=> Auth::user()->id,'type'=>'services'])->get();

        return view('Front.Services.Auth_pages.issues',$data);
    }
    ...
    public function ShowRegister()
    {
        ...
        return view('Front.Services.Auth_pages.register',$data);
    }
    ...
    public function register(RegisterRequest $request)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('front.services-home')->with('message',trans('back.messages.register_success_welcome_in_our_website'));
    ...
    {
        return view('Front.Services.Auth_pages.login');
    }

    public function servicesEditProfile(EditProfileRequest $request, $id)
    {
        ...
        return redirect()->route('front.services-profile')->with('success', 'تم تعديل بنجاح');
    }
    ...
    public function login(LoginRequest $request)
    {
        ...
        return redirect()->route('front.services-home')->with('message',trans('back.messages.login_successfully'));
    }
    ...
    public function logout()
    {
        ...
        Auth::logout();
        return redirect()->route('front.services-home')->with('message',trans('back.messages.logout_successfully'));
    }
