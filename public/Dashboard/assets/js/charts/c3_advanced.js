...
$(function () {
    ...
    //     data: {
    //         columns: [
    //             ['package1', 30, 200, 100, 400, 150, 250],
    //             ['package2', 130, 100, 140, 200, 150, 50]
    //         ]
    //     },
    //     grid: {
    //         y: {
    ...
    //     }, 1500);
    //     setTimeout(function () {
    //         transform.transform('bar', 'package1');
    //     }, 3000);
    //     setTimeout(function () {
    ...
    //     data: {
    //         columns: [
    //             ['package1', 30, -200, -100, 400, 150, 250, 100, 120, 150],
    //             ['package2', -50, 150, 150, -150, -50, -150, -120, -100, -120],
    //             ['package3', -100, 100, -40, 100, -150, -50, 90, -40, 100]
    //         ],
    //         groups: [
    //             ['package1', 'package2']
    //         ],
    ...
    var data_color = c3.generate({
        ...
        data: {
            columns: [
                ['package1', 30, 20, 50, 40, 60, 50],
                ['package2', 200, 130, 90, 240, 130, 220],
                ['package3', 300, 200, 160, 400, 250, 250]
            ],
            type: 'bar',
            colors: {
                package1: '#4DB6AC',
