            ...
            <div class="panel panel-flat" dir="{{ direction() }}" style="margin: 20px;">
                <div class="panel-heading">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('legal_settings.update') }}" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4"
                                        ...
                                        :</label>
                                    <div class="col-lg-8">
                                        <input type="phone" name="mobile" value="{{legalsettings('mobile') }}"
                                               class="form-control"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" name="whatsapp_phone"
                                               value="{{legalsettings('whatsapp_phone') }}"
                                               class="form-control"
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4"
                                        ...
                                        :</label>
                                    <div class="col-lg-8">
                                        <input type="email" name="email" value="{{legalsettings('email') }}"
                                               class="form-control"
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4"
                                        ...
                                        :</label>
                                    <div class="col-lg-8">
                                        <input type="text" name="address" value="{{legalsettings('address') }}"
                                               class="form-control"
                            ...
                            <form action="{{ route('legal_settings.update') }}" method="POST">
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4"
                                        ...
                                        :</label>
                                    <div class="col-lg-8">
                                        <input type="text" name="facebook_url" value="{{legalsettings('facebook_url') }}"
                                               class="form-control"
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4"
                                        ...
                                        :</label>
                                    <div class="col-lg-8">
                                        <input type="text" name="twitter_url" value="{{legalsettings('twitter_url') }}"
                                               class="form-control"
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4"
                                        ...
                                        :</label>
                                    <div class="col-lg-8">
                                        <input type="text" name="youtube_url" value="{{legalsettings('youtube_url') }}"
                                               class="form-control"
                                ...
                                <div class="form-group row">
                                    <label
                                        ...
                                        :</label>
                                    <div class="col-lg-8">
                                        <input type="text" name="linked_in_url" value="{{legalsettings('linked_in_url') }}"
                                               class="form-control"
...
{{--    @include('Dashboard.Domains.Legal.Settings.about&desc')--}}
    @include('Dashboard.Domains.Legal.Settings.terms')
@stop
...
{{--    @include('Dashboard.Domains.Legal.Settings.app_location_map')--}}

    @include('Maps.map',[
    'latetude'=>App\Models\LegalSetting::where('key','latitude')->first()->value,
    'longetude'=>App\Models\LegalSetting::where('key','longitude')->first()->value])
