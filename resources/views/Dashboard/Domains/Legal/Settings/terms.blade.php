                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <textarea rows="5" cols="5" name="conditions_terms_ar" class="  form-control "
                                                  placeholder="{{ trans('back.settings.conditions_terms_ar') }}">{{legalsettings('conditions_terms_ar') }}
                                        </textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                                <textarea rows="5" cols="5" name="conditions_terms_en"
                                                          class="form-control"
                                                          placeholder="{{ trans('back.settings.conditions_terms_en') }}">{{legalsettings('conditions_terms_en') }}
                                                </textarea>
                                    </div>
                                </div>
...
{{--                                                  placeholder="{{ trans('back.settings.privacy_ar') }}">{{legalsettings('privacy_ar') }}--}}
{{--                                        </textarea>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                                <div class="form-group row">--}}
...
{{--                                                          class="form-control"--}}
{{--                                                          placeholder="{{ trans('back.settings.privacy_en') }}">{{legalsettings('privacy_en') }}--}}
{{--                                                </textarea>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                                <legend class="font-weight-semibold text-uppercase font-size-sm"></legend>--}}
