                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <textarea rows="5" cols="5" name="conditions_terms_ar" class="  form-control "
                                                  placeholder="{{ trans('back.settings.conditions_terms_ar') }}">{{shaabansettings('conditions_terms_ar') }}
                                        </textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                                <textarea rows="5" cols="5" name="conditions_terms_en"
                                                          class="form-control"
                                                          placeholder="{{ trans('back.settings.conditions_terms_en') }}">{{shaabansettings('conditions_terms_en') }}
                                                </textarea>
                                    </div>
                                </div>
...
{{--                                                  placeholder="{{ trans('back.settings.privacy_ar') }}">{{shaabansettings('privacy_ar') }}--}}
{{--                                        </textarea>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                                <div class="form-group row">--}}
...
{{--                                                          class="form-control"--}}
{{--                                                          placeholder="{{ trans('back.settings.privacy_en') }}">{{shaabansettings('privacy_en') }}--}}
{{--                                                </textarea>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                                <legend class="font-weight-semibold text-uppercase font-size-sm"></legend>--}}
