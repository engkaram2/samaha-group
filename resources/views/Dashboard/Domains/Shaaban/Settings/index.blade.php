            ...
            <div class="panel panel-flat" dir="{{ direction() }}" style="margin: 20px;">
                <div class="panel-heading">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('shaaban_settings.update') }}" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4"
                                        ...
                                        :</label>
                                    <div class="col-lg-8">
                                        <input type="phone" name="mobile" value="{{shaabansettings('mobile') }}"
                                               class="form-control"
...
{{--                                               value="{{shaabansettings('whatsapp_phone') }}"--}}
{{--                                               class="form-control"--}}
...
{{--                                </div>--}}
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4"
                                        ...
                                        :</label>
                                    <div class="col-lg-8">
                                        <input type="email" name="email" value="{{shaabansettings('email') }}"
                                               class="form-control"
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4"
                                        ...
                                        :</label>
                                    <div class="col-lg-8">
                                        <input type="text" name="address" value="{{shaabansettings('address') }}"
                                               class="form-control"
            ...
            <div class="panel panel-flat" dir="{{ direction() }}" style="margin: 20px;">
                <div class="panel-heading">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('shaaban_settings.update') }}" method="POST">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4"
                                        ...
                                        :</label>
                                    <div class="col-lg-8">
                                        <input type="text" name="facebook_url" value="{{shaabansettings('facebook_url') }}"
                                               class="form-control"
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4"
                                        ...
                                        :</label>
                                    <div class="col-lg-8">
                                        <input type="text" name="twitter_url" value="{{shaabansettings('twitter_url') }}"
                                               class="form-control"
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4"
                                        ...
                                        :</label>
                                    <div class="col-lg-8">
                                        <input type="text" name="youtube_url" value="{{shaabansettings('youtube_url') }}"
                                               class="form-control"
                                ...
                                <div class="form-group row">
                                    <label
                                        ...
                                        :</label>
                                    <div class="col-lg-8">
                                        <input type="text" name="linked_in_url" value="{{shaabansettings('linked_in_url') }}"
                                               class="form-control"
