            ...
            <div class="panel panel-flat" dir="{{ direction() }}" style="margin: 20px;">
                <div class="panel-heading">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('translation_settings.update') }}" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4"
                                        ...
                                        :</label>
                                    <div class="col-lg-8">
                                        <input type="phone" name="mobile" value="{{translationsettings('mobile') }}"
                                               class="form-control"
...
{{--                                               value="{{translationsettings('whatsapp_phone') }}"--}}
{{--                                               class="form-control"--}}
...
{{--                                </div>--}}
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4"
                                        ...
                                        :</label>
                                    <div class="col-lg-8">
                                        <input type="email" name="email" value="{{translationsettings('email') }}"
                                               class="form-control"
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4"
                                        ...
                                        :</label>
                                    <div class="col-lg-8">
                                        <input type="text" name="address" value="{{translationsettings('address') }}"
                                               class="form-control"
                            ...
                            <form action="{{ route('translation_settings.update') }}" method="POST">
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4"
                                        ...
                                        :</label>
                                    <div class="col-lg-8">
                                        <input type="text" name="facebook_url" value="{{translationsettings('facebook_url') }}"
                                               class="form-control"
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4"
                                        ...
                                        :</label>
                                    <div class="col-lg-8">
                                        <input type="text" name="twitter_url" value="{{translationsettings('twitter_url') }}"
                                               class="form-control"
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4"
                                        ...
                                        :</label>
                                    <div class="col-lg-8">
                                        <input type="text" name="youtube_url" value="{{translationsettings('youtube_url') }}"
                                               class="form-control"
                                ...
                                <div class="form-group row">
                                    <label
                                        ...
                                        :</label>
                                    <div class="col-lg-8">
                                        <input type="text" name="linked_in_url" value="{{translationsettings('linked_in_url') }}"
                                               class="form-control"
...
{{--    @include('Dashboard.Domains.Translation.Settings.about&desc')--}}
    @include('Dashboard.Domains.Translation.Settings.terms')
...
{{--    @include('Dashboard.Domains.Translation.Settings.app_location_map')--}}
    ...
    @include('Maps.map',[
  'latetude'=>App\Models\TranslationSetting::where('key','latitude')->first()->value,
  'longetude'=>App\Models\TranslationSetting::where('key','longitude')->first()->value])
