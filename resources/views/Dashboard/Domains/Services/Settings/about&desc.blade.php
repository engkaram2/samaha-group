                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                                <textarea rows="5" cols="5" name="about_app_ar" class="form-control"
                                                          placeholder="{{ trans('back.settings.about_app_ar') }}">{{servicessettings('about_app_ar') }}
                                                </textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                                <textarea rows="5" cols="5" name="about_app_en" class="form-control"
                                                          placeholder="{{ trans('back.settings.about_app_en') }}">{{servicessettings('about_app_en') }}
                                                </textarea>
                                    </div>
                                </div>
...
{{--                                                          placeholder="{{ trans('back.settings.app_description_ar') }}">{{servicessettings('app_description_ar') }}--}}
{{--                                                </textarea>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                        <div class="form-group row">--}}
...
{{--                                                          placeholder="{{ trans('back.settings.app_description_en') }}">{{servicessettings('app_description_en') }}--}}
{{--                                                </textarea>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                        <legend class="font-weight-semibold text-uppercase font-size-sm"></legend>--}}
