            ...
            <div class="panel panel-flat" dir="{{ direction() }}" style="margin: 20px;">
                <div class="panel-heading">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('services_settings.update') }}" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4"
                                        ...
                                        :</label>
                                    <div class="col-lg-8">
                                        <input type="phone" name="mobile" value="{{servicessettings('mobile') }}"
                                               class="form-control"
...
{{--                                               value="{{servicessettings('whatsapp_phone') }}"--}}
{{--                                               class="form-control"--}}
...
{{--                                </div>--}}
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4"
                                        ...
                                        :</label>
                                    <div class="col-lg-8">
                                        <input type="email" name="email" value="{{servicessettings('email') }}"
                                               class="form-control"
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4"
                                        ...
                                        :</label>
                                    <div class="col-lg-8">
                                        <input type="text" name="address" value="{{servicessettings('address') }}"
                                               class="form-control"
            ...
            <div class="panel panel-flat" dir="{{ direction() }}" style="margin: 20px;">
                <div class="panel-heading">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('services_settings.update') }}" method="POST">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4"
                                        ...
                                        :</label>
                                    <div class="col-lg-8">
                                        <input type="text" name="facebook_url" value="{{servicessettings('facebook_url') }}"
                                               class="form-control"
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4"
                                        ...
                                        :</label>
                                    <div class="col-lg-8">
                                        <input type="text" name="twitter_url" value="{{servicessettings('twitter_url') }}"
                                               class="form-control"
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-4"
                                        ...
                                        :</label>
                                    <div class="col-lg-8">
                                        <input type="text" name="youtube_url" value="{{servicessettings('youtube_url') }}"
                                               class="form-control"
                                ...
                                <div class="form-group row">
                                    <label
                                        ...
                                        :</label>
                                    <div class="col-lg-8">
                                        <input type="text" name="linked_in_url" value="{{servicessettings('linked_in_url') }}"
                                               class="form-control"
...
{{--    @include('Dashboard.Domains.Services.Settings.about&desc')--}}
    @include('Dashboard.Domains.Services.Settings.terms')
...
@section('scripts')
    <script>
        ...
        CKEDITOR.replace('privacy_ar', {height: '200px'});
        CKEDITOR.replace('privacy_en', {height: '200px'});
...
{{--    @include('Dashboard.Domains.Translation.Settings.app_location_map')--}}
    ...
    @include('Maps.map',[
    'latetude'=>App\Models\ServiceSetting::where('key','latitude')->first()->value,
    'longetude'=>App\Models\ServiceSetting::where('key','longitude')->first()->value])
