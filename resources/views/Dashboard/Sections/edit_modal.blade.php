<!--  modal -->
<div id="edit_section_{{$section->id}}" class="modal fade">
                    ...
                    <form action="{{ route('sections.update',$section->id) }}"
                        ...
                        <div class="panel panel-flat">
                            <div class="panel-heading">
                                <h5 class="panel-title"></b>@lang('back.edit-var',['var'=>trans('back.section.section')])
                                </h5>
                            ...
                            <div class="panel-body">
                                <div class="box-body">
                                    <input type="hidden" name="image_id" value="{{$section->id}}"/>

                                    <div class="form-group">
                                        <input type="text" class="form-control"
                                               value="{{$section->name_ar}}" name="name_ar"
                                               placeholder="@lang('back.name_ar') ">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control"
                                               value="{{$section->name_en}}" name="name_en"
