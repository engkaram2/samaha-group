...
<script >
    ...
    function websdkready() {
        ...
        {{--var API_KEY = "{{env('ZOOM_CLIENT_KEY')}}";--}}
        //var API_KEY = "HzE13xHYTl-T_C3ybEjZPQ";
         ...
         */
        {{--var API_SECRET = "{{env('ZOOM_CLIENT_SECRET')}}";--}}
        //var API_SECRET = "w4R1UYwh9WS2lE0kB2esPU5YV1TZE0iKdXtm";
        ...
        document.getElementById("display_name").value ='{{request()->email}}'
            ...
            .addEventListener("click", function (e) {
                ...
                var signature = ZoomMtg.generateSignature({
                    ...
                    success: function (res) {
                     ...
                     //   meetingConfig.meeting_title = '{{request()->meeting_title}}';
                        var joinUrl = "{{route('zoom.meeting')}}?" + testTool.serialize(meetingConfig);
                        // var joinUrl = "https://us05web.zoom.us/j/82689448533?pwd=uC5QnDwnEmg2ZKbZYRIxwdZSbWAnc4.1";
                        console.log(joinUrl);
        ...
        window.copyJoinLink = function (element) {
            ...
            var signature = ZoomMtg.generateSignature({
                ...
                {{--    meetingConfig.signature = res.result;--}}
                {{--    meetingConfig.apiKey = API_KEY;--}}
                {{--    var joinUrl = testTool.getCurrentDomain() +--}}
                {{--        "{{route('zoom.meeting')}}?" +--}}
