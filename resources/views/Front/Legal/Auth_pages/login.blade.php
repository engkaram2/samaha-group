        ...
        <div class="row">
            <div class="col-12 col-xl-6 mx-auto">
                <div class="about_desWrap whiteBK_RGstWrap mdLog_padding">
                    ...
                    <form   class="contactUs__form" action="{{route('front.login')}}" method="post" id="submitted-form" enctype="multipart/form-data">
                        @csrf
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body appointModal__body">
                ...
                <form class="contactUs__form" action="{{route('front.legal-forget-pass')}}" method="post"
