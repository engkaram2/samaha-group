...
<body>
@include('Front.layouts.legal.nav')
...
<div class="editPro_wrap">
    <div class="container pxLG-0">
        <div class="editPro_ulist">
            <a href="profile.html" class="editLink activeLink"> edit profile </a>
            <a href="{{route('front.legal-issues')}}" class="editLink "> issues </a>
        </div>
    </div>
</div>
...
<section class="contact_section secPadding">
    <div class="container pxLG-0">
        ...
        <form action="{{ route('front.legal-edit-profile', $user->id) }}" method="POST" class="profile__form"
