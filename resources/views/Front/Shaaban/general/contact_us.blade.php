...
@section('content')
    ...
    <section class="greySEC_section secPadding">
        <div class="container pxLG-0">
            <div class="about_desWrap maxWidth_400">
                ...
                <div class="col-12 col-lg-6 col-xl-5">
                    <div class="contINfo_col">
                        <div class="contINfo_Cwrap">
                            <h5> Information </h5>
                            <p> Shaaban Samaha  and Legal Consultants is one of the leading offices in the legal profession in the United Arab Emirates and the Arab Republic  of Egypt. </p>
                            <div class="contINFo_line">
                                <i class="fa-solid fa-phone"></i>
                                <span> phone: </span>
                                <a href="#"> {{ App\Models\ShabaanSetting:: where('key','mobile')->first()->value}} </a>
                            </div>
                            <div class="contINFo_line">
                                <i class="fa-solid fa-location-dot"></i>
                                <span> address: </span>
                                <a href="#"> {{ App\Models\ShabaanSetting:: where('key','address')->first()->value}} </a>
                            </div>
                            <div class="contINFo_line">
                                <i class="fa-solid fa-envelope"></i>
                                <span> email: </span>
                                <a href="#"> {{ App\Models\ShabaanSetting:: where('key','email')->first()->value}} </a>
                            </div>
                        </div>
                        <div class="contINfo_Cwrap">
                            <h5> working hours </h5>
    ...
    <section class="contact_section secPadding">
        <div class="container pxLG-0">
            <div class="about_desWrap">
                <span class="smOffer myFlex__center mx-auto"> Free Consultations </span>
                <h3 class="text-center"> Get in <span> touch </span> </h3>
                <form action="{{route('front.shaaban-contact-us')}}" method="post" class="contactUs__form">
                    @csrf
