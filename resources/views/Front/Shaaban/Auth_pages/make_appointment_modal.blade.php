    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body appointModal__body">
                ...
                <p> When making an shaaban appointment you should give the person your name and the reason for wanting an
                ...
                <form class="contactUs__form" action="{{route('front.shaaban-make-appointment')}}" method="post"
