...
@section('content')
    <!--start main section-->
    <section class="innerFourth__section inShFifth__color">
            ...
            <div class="row">
                <div class="col-12 col-lg-6 col-xl-7">
                    <div class="about_desWrap">
                        ...
                        <form action="{{route('front.jasem-contact-us')}}" method="post" class="contactUs__form">
                            @csrf
                    ...
                    <div class="contINfo_col">
                        <div class="contINfo_Cwrap">
                            ...
                            <div class="contINFo_line">
                                ...
                                <span> phone: </span>
                                <a href="#"> {{ App\Models\JasemSetting:: where('key','mobile')->first()->value}} </a>
                            </div>
                            <div class="contINFo_line">
                                <i class="fa-solid fa-location-dot"></i>
                                <span> address: </span>
                                <a href="#"> {{ App\Models\JasemSetting:: where('key','address')->first()->value}} </a>
                            </div>
                            <div class="contINFo_line">
                                <i class="fa-solid fa-envelope"></i>
                                <span> email: </span>
                                <a href="#"> {{ App\Models\JasemSetting:: where('key','email')->first()->value}} </a>
                            </div>
                        </div>
                        <div class="contINfo_Cwrap">
                            <h5> working hours </h5>
