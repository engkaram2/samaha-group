            ...
            <div class="col-12 col-xl-6 mx-auto">
                <div class="about_desWrap whiteBK_RGstWrap mdLog_padding">
                    ...
                    <h3> <span> welcome back! </span> </h3>
                     <form   class="contactUs__form" action="{{route('front.jasem-login')}}" method="post" id="submitted-form" enctype="multipart/form-data">
                            @csrf
...
{{--                        <a href="forget_pass.html" class="forget_pass mbttom__20"> forget password ? </a>--}}
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body appointModal__body">
                ...
                <form class="contactUs__form" action="{{route('front.jasem-forget-pass')}}" method="post"
...
{{--                            <input type="number" min="0" max="9" class="code__input" required>--}}
{{--                            <input type="number" min="0" max="9" class="code__input" required>--}}
{{--                            <input type="number" min="0" max="9" class="code__input" required>--}}
{{--                            <input type="number" min="0" max="9" class="code__input" required>--}}
{{--                        </div>--}}
{{--                        <button type="submit" class="main__btn search__btn hvr-bounce-to-right w-100 mbTop_10"> send </button>--}}
{{--                    </form>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}
