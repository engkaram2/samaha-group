        ...
        <div class="welcome_section bdBttm_md">
            <div class="container welcmInner_container pxLG-0">
                <h3 class="wow fadeInDown" data-wow-duration="1.3s" data-wow-offset="100" data-wow-delay="1s"> my
                    profile </h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('front.jasem-home')}}">samaha jasem > </a></li>
    ...
    <div class="editPro_wrap">
        <div class="container pxLG-0">
            <div class="editPro_ulist">
                <a href="{{route('front.jasem-profile')}}" class="editLink"> edit profile </a>
                <a href="{{route('front.jasem-issues')}}" class="editLink activeLink"> issues </a>
            </div>
        </div>
    </div>
                ...
                <div class="row issData_row">
                    ...
                    @foreach($my_issues as $issue)
                        <div class="col-12 col-md-6 col-lg-4">
                            <a href="#" data-toggle="modal" data-target="#issueModal-{{$issue->id}}"
                               class="issuDt__card">
                        ...
                        <!-- help modal-->
                        <div class="modal loginModal fade" id="issueModal-{{$issue->id}}" tabindex="-1" role="dialog"
                                            ...
                                            <form action="">
                                                ...
                                                <div class="Cform__row">
                                                    <div class="col-12 col-xl-6">
                                                        issue_name <input type="text" class="contact__input"
                                                                          placeholder=" {{$issue->issue_name}} ">
                                                    </div>
                                                    <div class="col-12 col-xl-6">
                                                        issue_number <input type="text" class="contact__input"
                                                                            placeholder=" {{$issue->issue_number}}">
                                                    </div>
                                                    <div class="col-12 col-xl-6">
                                                        status <input type="text" class="contact__input"
                                                ...
                                                <div class="Cform__row">
                                                    @foreach($issue->files as $file)
                                                        <div class="col-12 col-lg-6">
                                                            <a href="{{route('jasem-view',$file->id)}}" target="_blank">
                                                                ...
                                                                <div class="upload__group">
                                                                    ...
                                                                    {{--                                                        </div>--}}
                                                                    <img src="{{asset('Front/assets')}}/img/pdf.svg"
                                                                         alt="" class="pdf_abs">
                                                                </div>
                                                            </a>
                                                        </div>
