        ...
        <div class="row">
            <div class="col-12 col-xl-6 mx-auto">
                <div class="about_desWrap whiteBK_RGstWrap mdLog_padding">
                    <span class="smOffer myFlex__center"> welcome back!</span>
                    <h3> <span> {{trans('back.reset_pass')}}</span> </h3>
                     <form  class="contactUs__form" action="{{route('front.jasem-resetPassword')}}" method="post" id="submitted-form" enctype="multipart/form-data">
                            @csrf
