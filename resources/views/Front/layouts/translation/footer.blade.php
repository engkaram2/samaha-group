            ...
            <div class="row fLinks__row">
                <div class="col-12 col-md-6 col-xl-2 cMDCenter">
                    <div class="footer__col ptSM__30">
                        <a href="{{route('front.translation-home')}}" class="footer__logo">
                            <img src="{{asset('Front/assets')}}/img/logo-t2.png" alt="">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-xl-2">
                    <div class="footer__col">
                        ...
                        <ul class="ftUL_list">
                            ...
                            <li><a href="{{route('front.translation-terms')}}" class="footer_link"> terms and conditions </a></li>
                        ...
                        <ul class="ftUL_list">
                            <li>
                                <a href="{{route('front.translation-home')}}" class="footer_link">
                                    <i class="icon-phone_call"></i> <span> {{App\Models\TranslationSetting::where('key','mobile')->first()->value}} </span>
                                </a>
                            </li>
                            <li>
                                <a href="{{route('front.translation-home')}}" class="footer_link">
                                    <i class="icon-email_mail"></i> <u> {{App\Models\TranslationSetting::where('key','email')->first()->value}} </u>
                                </a>
                            </li>
                            <li>
                                <a href="{{route('front.translation-home')}}" class="footer_link">
                                    <i class="icon-location_map"></i> <span> {{App\Models\TranslationSetting::where('key','address')->first()->value}} </span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="footer__col pdTop_40">
                        ...
                        <div class="social__links">
                            <a href="{{ App\Models\TranslationSetting:: where('key','twitter_url')->first()->value}}" class="soc_link"> <i class="fa-brands fa-twitter"></i> </a>
                            <a href="{{ App\Models\TranslationSetting:: where('key','linked_in_url')->first()->value}}" class="soc_link"> <i class="fa-brands fa-linkedin-in"></i> </a>
                            <a href="{{App\Models\TranslationSetting::where('key','facebook_url')->first()->value}}" class="soc_link"> <i class="fa-brands fa-facebook-f"></i> </a>
                            <a href="{{ App\Models\TranslationSetting:: where('key','youtube_url')->first()->value}}" class="soc_link"> <i class="fa-brands fa-youtube"></i> </a>
...
{{--                        </form>--}}
    ...
    <div class="copyrights">
        <div class="all__rights"> Copyright Ⓒ Samaha Translations Consutants 2023. </div>
    </div>
</footer>
