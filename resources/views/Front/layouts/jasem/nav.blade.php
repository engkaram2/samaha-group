    ...
    <div class="container">
        ...
        <ul class="navigation desktop__nav">
            <li class="nav-item item_has_child">
                <a href="{{route('front.jasem-services')}}" class="nav-link dropdown-toggle">
            ...
            <li class="nav-item">
                <a href="{{route('front.show-jasem-contact-us')}}" class="nav-link">{{trans('back.nav.contact_us')}} </a>
            </li>
            <li class="nav-item">
...
{{--        <a href="search.html" class="main__btn srchThird_btn hvr-bounce-to-right mbTm_15"> <i class="icon-search"></i> search </a>--}}
        <a href="{{route('front.jasem-show-search')}}" class="main__btn srchThird_btn hvr-bounce-to-right mbTm_15"> <i
...
{{--       --}}
            ...
            @if(auth()->check())
                <a href="{{route('front.jasem-notifications')}}" class="lang_link"> <i class="icon-notification"></i>
                </a>
                <a href=" {{route('front.jasem-profile')}}" class="lang_link"> <i class="icon-user"></i> </a>
                <a href=" {{route('front.jasem-logout')}}" class="lang_link"> <i class="fas fa-unlock"></i> </a>
            @else
...
<header>
    <div class="container header__container pxLG-0">
        <a href="{{route('front.jasem-home')}}" class="my_logo5">
            <img src="{{asset('Front/assets')}}/img/logo5.png" alt="">
        </a>
        ...
        <a href="{{route('front.jasem-show-search')}}" class="main__btn srchThird_btn hvr-bounce-to-right d__mob__none"> <i
                class="icon-search"></i> search </a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body loginModal__body">
                ...
                <h3> welcome to Jasem samaha </h3>
                <p> Now, you can log in or register in our website to enjoy our services </p>
                <div class="buttons_wrapper">
                    <a href="{{route('front.jasem-show-login')}}" class="main__btn mydefault_btn whiteBK__btn mrEnd_SM">
                        login </a>
                    <a href="{{route('front.jasem-show-register')}}"
...
<!-- appointment modal-->
@include('Front.Jasem.Auth_pages.make_appointment_modal')
...
{{--                    <a href="register3.html" class="main__btn myborderd_btn whiteBK__btn mrEnd_SM"> register </a>--}}
{{--                    <a href="appointment3.html" class="main__btn myborderd_btn blueBK__btn"> confirm </a>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}
{{--    </div>--}}
...
{{--            <li class="nav-item">--}}
{{--                <a href="index_jasem_ar.html" class="nav-link"> ar </a>--}}
{{--            </li>--}}
