...
<div class="editPro_wrap">
    <div class="container pxLG-0">
        <div class="editPro_ulist">
            ...
            <a href="{{route('front.translation-translations')}}" class="editLink "> my translations </a>
        </div>
    </div>
</div>
...
<section class="contact_section secPadding">
    <div class="container pxLG-0">
        ...
        <form action="{{ route('front.translation-edit-profile', $user->id) }}" method="POST" class="profile__form"
