            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    <div class="about_topWrap">
                        ...
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html">samaha services > </a></li>
                    ...
                    <div class="contINfo_col">
                        <div class="contINfo_Cwrap">
                            ...
                            <div class="contINFo_line">
                                ...
                                <span> phone: </span>
                                <a href="#"> {{ App\Models\ServiceSetting:: where('key','mobile')->first()->value}} </a>
                            </div>
                            <div class="contINFo_line">
                                <i class="fa-solid fa-location-dot"></i>
                                <span> address: </span>
                                <a href="#"> {{ App\Models\ServiceSetting:: where('key','address')->first()->value}} </a>
                            </div>
                            <div class="contINFo_line">
                                <i class="fa-solid fa-envelope"></i>
                                <span> email: </span>
                                <a href="#"> {{ App\Models\ServiceSetting:: where('key','email')->first()->value}} </a>
                            </div>
                        </div>
                        <div class="contINfo_Cwrap">
                            <h5> working hours </h5>
    ...
    <section class="contact_section secPadding">
        <div class="container pxLG-0">
            <div class="about_desWrap">
                <span class="smOffer myFlex__center"> Free Consultations </span>
                <h3> Get in touch </h3>
                <form action="{{route('front.services-contact-us')}}" method="post" class="contactUs__form">
                  @csrf
