    ...
    <div class="editPro_wrap">
        <div class="container pxLG-0">
            <div class="editPro_ulist">
                <a href="{{route('front.services-profile')}}" class="editLink"> edit profile </a>
                <a href="{{route('front.services-issues')}}" class="editLink activeLink"> issues </a>
            </div>
        </div>
    </div>
                                        ...
                                        <form action="">
                                            ...
                                            <div class="Cform__row">
                                                ...
                                                <div class="col-12 col-lg-6">
                                                    <a href="{{route('services-view',$file->id)}}" target="_blank">
