...
var firebaseApp = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'firebase/app'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())({
...
var firestore_db = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'firebase/firestore'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();
var docRef = firestore_db.collection('users').doc('chat');
await docRef.set({
  message: 'hello'
});
...
/******/ 	var __webpack_exports__ = __webpack_require__("./public/firebase_chat.js");
/******/ 	
/******/ })()
;